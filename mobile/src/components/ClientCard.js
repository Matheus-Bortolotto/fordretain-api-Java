...
const styles = StyleSheet.create({
  ...
  actions: { flexDirection: 'row', gap: 8, marginTop: 13 }, secondaryButton: { flex: 1, paddingVertical: 10, borderRadius: radius.md, borderWidth: 1, borderColor: colors.border, alignItems: 'center' }, secondaryButtonText: { color: colors.fordBlue, fontWeight: font.weight.black, fontSize: 11 }, primaryButton: { flex: 1, paddingVertical: 10, borderRadius: radius.md, backgroundColor: colors.fordBlue, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 7 }, primaryButtonText: { color: colors.white, fontWeight: font.weight.black, fontSize: 11 }, arrow: { color: colors.white, fontWeight: font.weight.black, fontSize: 16 },
});
